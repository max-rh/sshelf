...
> `sshelf/` later, which has no effect on the build.
...
v1 feature-complete (M0 to M8): fuzzy list + connect (`exec` handoff), add/edit/delete form,
...
- `docs/` holds the living documentation (see `docs/index.md`).
